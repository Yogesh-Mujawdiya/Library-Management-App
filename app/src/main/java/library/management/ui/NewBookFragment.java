...
import library.management.Controller.NewBookAdapter;
...
public class NewBookFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        URL_Book = Host+"/NewBook.php";
        recyclerView = (RecyclerView) root.findViewById(R.id.NewBookRecyclerView) ;
                        ...
                        try {
                            ...
                            for(int i=0; i<jArray.length(); i++){
                                ...
                                Book project = new Book(
                                        ...
                                        json_data.getString("publication"),
                                        json_data.getString("edition")
                                );
                                BookList.add(project);
                            }
                            adapter = new NewBookAdapter(getActivity(),BookList);
